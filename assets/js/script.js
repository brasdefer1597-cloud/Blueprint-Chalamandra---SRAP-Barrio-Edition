...
// Optimization: Cache metric elements to avoid innerHTML reparsing
...
function updateUI() {
  ...
  // Optimization: Update textContent instead of innerHTML to avoid layout thrashing and reparsing
