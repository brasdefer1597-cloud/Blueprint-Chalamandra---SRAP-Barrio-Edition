...
// Performance Optimization: Cache for dirty checking to reduce DOM writes
...
function updateScores() {
  // Update Insight Counter only if changed
  ...
  // Update Epic Disaster Level only if changed
  if (
    metricDisaster &&
  ...
  // Update Flow Control only if changed
