...
function sanitizeHTML(html) {
  ...
  allElements.forEach((el) => {
    for (let i = el.attributes.length - 1; i >= 0; i--) {
      ...
      // Sentinel: Sanitize attribute values by removing all control characters ([\x00-\x20])
      // This prevents XSS bypasses that embed control characters (e.g., java&#x09;script:)
      // Also block vbscript: scheme
