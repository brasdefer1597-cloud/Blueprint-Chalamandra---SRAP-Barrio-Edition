...
// ⚡ Bolt Optimization: JS-level cache for dirty checking to prevent redundant DOM writes without expensive DOM reads
...
function updateScores() {
  ...
  if (lastRenderedState.flowClass !== newFlowClass) {
    metricFlow.className = newFlowClass;
    lastRenderedState.flowClass = newFlowClass;
  }
}
